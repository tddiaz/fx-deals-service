 ...
 */
public class FileNotEmptyValidatorTest {
    ...
    public void testInvalidFormat() {
        ...
        beanValidation.setFile(new TestMultipartFile("filename.csv"));
    ...
    public void testValidFormat() {
        ...
        BeanValidation beanValidation = new BeanValidation();
        beanValidation.setFile(new TestMultipartFile("filename.csv", 1));
